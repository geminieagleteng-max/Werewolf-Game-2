    ...
    skills: [
      {
        ...
        phase: '每晚預言家行動階段',
        triggerType: '主動發動 (夜間)',
        effect: '每晚可同時指定最多 2 名存活玩家，水晶球將同時揭曉他們的真實陣營為【好人陣營】或【狼人陣營】。',
        restrictions: '僅能得知好人或狼人，無法直接判斷具體神職（如女巫/獵人）或村民身分。',
      },
    ],
    strategyTips: [
      '每晚可一次性查驗 2 位玩家，能更快鎖定場上狼人與好人金水！',
      '首日白天發言應清晰報出昨夜的 2 位查驗結果（雙金水、一金一查殺或雙查殺）。',
      '面對悍跳狼人對跳時，保持自信冷靜，以查驗邏輯與視角差異說服場上好人。',
    ],
    faq: [
      { q: '預言家能查驗已經出局的玩家嗎？', a: '不能，只能查驗當前場上存活的玩家。' },
      { q: '預言家一定要選滿 2 個人嗎？', a: '不一定，您可以選擇 1 位或 2 位玩家進行查驗。' },
