    ...
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-60px)] p-6 bg-zinc-950">
        <div className="w-full max-w-3xl bg-zinc-900/70 border border-zinc-800 rounded-2xl p-8 shadow-sm backdrop-blur-md">
          ...
          {/* Google 快速登入/身分卡片 */}
          <div className="max-w-sm mx-auto mb-5 p-3.5 bg-zinc-950 border border-zinc-800 rounded-2xl flex items-center justify-between shadow-sm">
            <div className="flex items-center gap-3">
              <div className="relative">
                {currentUser?.picture ? (
                  ...
                  <div className="w-11 h-11 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xl text-zinc-400">
                    👤
                  </div>
                )}
                {isGoogleLinked && (
              ...
              <div>
                ...
                <div className="text-[11px] text-zinc-400">
                  {isGoogleLinked ? currentUser.email : '訪客遊玩模式'}
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="px-3 py-1.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-xs font-medium text-zinc-200 rounded-xl transition-all cursor-pointer shadow-sm flex items-center gap-1.5"
            >
              ...
              <span>{isGoogleLinked ? '帳號設定' : 'Google 登入'}</span>
            </button>
          </div>
