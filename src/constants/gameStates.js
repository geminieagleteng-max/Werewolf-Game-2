...
const PHASE_DURATIONS = {
  ...
  [GAME_PHASES.NIGHT_GUARD]: 15,
  [GAME_PHASES.NIGHT_WEREWOLF]: 20,
  [GAME_PHASES.NIGHT_SEER]: 15,
  [GAME_PHASES.NIGHT_WITCH]: 20,
  [GAME_PHASES.DAY_ANNOUNCE]: 5,
  [GAME_PHASES.DAY_DISCUSSION]: 120,
  [GAME_PHASES.DAY_VOTING]: 20,
  [GAME_PHASES.DAY_VOTE_RESULT]: 5,
  [GAME_PHASES.HUNTER_SHOOT]: 15,
};
